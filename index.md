...
## [Copy heading link](/avishay-tal/\#h.abucxgftu8fh)    Main Research Interests
...
## [Copy heading link](/avishay-tal/\#h.kpmqp4c3xtf5)    Contact Information
...
## [Copy heading link](/avishay-tal/\#h.42glmif1dx9)    Events
...
## [Copy heading link](/avishay-tal/\#h.yjgzw43p0cyt)    Teaching
...
## [Copy heading link](/avishay-tal/\#h.e31pslhuhbzv)    Program Committees
...
## [Copy heading link](/avishay-tal/\#h.2a554vkl4ghf)    Group Information
...
## [Copy heading link](/avishay-tal/\#h.9pjov06tw5hx)    Publications
...
02. The Power of Adaptivity in Quantum Query Algorithms
...
03. Tight Time-Space Lower Bounds for Constant-Pass Learning

     [PDF](https://arxiv.org/abs/2310.08070) joint with Xin Lyu, Hongxun Wu, and Junzhao Yang

    FOCS, 2023.

04. Weighted Pseudorandom Generators via Inverse Analysis of Random Walks and Shortcutting
...
17. Towards Optimal Separations between Quantum and Randomized Query Complexities

     [PDF](https://eccc.weizmann.ac.il/report/2019/179/) [FOCS Long Talk](https://www.youtube.com/watch?v=VYmxY6zLy1I) FOCS, 2020.

18. Quantum versus Randomized Communication Complexity, with Efficient Players
...
22. Oracle Separation of BQP and PH
...
24. Pseudorandom Generators for Width-3 Branching Programs
...
25. Pseudorandom generators from the second Fourier level and applications to AC0 with parity gates

     [PDF](http://eccc.weizmann.ac.il/report/2018/155/) joint with Eshan Chattopadhyay, Pooya Hatami, and Shachar Lovett.

    ITCS, 2019.

26. Cubic Formula Size Lower Bounds Based on Compositions with Majority

     [PDF](http://eccc.weizmann.ac.il/report/2018/160/) joint with Anna Gal and Adrian Trejo Nuñez.

    ITCS, 2019.

27. Improved Pseudorandomness for Unordered Branching Programs through Local Monotonicity

     [PDF](http://eccc.weizmann.ac.il/report/2017/171/) joint with Eshan Chattopadhyay, Pooya Hatami and Omer Reingold.

    STOC, 2018.

28. Extractor-Based Time-Space Lower Bounds for Learning

     [PDF](https://arxiv.org/abs/1708.02639) joint with Sumegha Garg and Ran Raz.

    STOC, 2018.

29. On Constant-Depth Canonical Boolean Circuits for Computing Multilinear Functions
...
30. The Choice and Agreement Problems of a Random Function

     [PDF](http://eccc.weizmann.ac.il/report/2017/148/) joint with Or Meir.

    Information Processing Letters, Volume 133, 2018.

31. Pseudorandom Generators for Low Sensitivity Functions

     [PDF](http://eccc.weizmann.ac.il/report/2017/025/) joint with Pooya Hatami.

    ITCS, 2018.

32. Robust Sensitivity

     [PDF](http://eccc.weizmann.ac.il/report/2016/161/) joint with Shachar Lovett and Jiapeng Zhang.

    SODA, 2018.

33. Lower Bounds for 2-Query LCCs over Large Alphabet

     [PDF](https://arxiv.org/abs/1611.06980) joint with Arnab Bhattacharyya and Sivakanth Gopi.

    RANDOM, 2017.

34. Tight Bounds on The Fourier Spectrum of AC0

     [PDF](http://eccc.weizmann.ac.il/report/2014/174/) [Slides](https://drive.google.com/open?id=1G0WNtCM1Sum4Y8hgvWwgQ69xBWnknDjD) CCC, 2017.

     [\[Oded's choices\]](http://www.wisdom.weizmann.ac.il/~oded/MC/171.html)

35. The Bipartite Formula Complexity of Inner-Product is Quadratic

     [PDF](http://eccc.weizmann.ac.il/report/2016/181/) STOC, 2017 (merged with "Computing Requires Larger Formulas than Approximating").

36. Computing Requires Larger Formulas than Approximating

     [PDF](https://eccc.weizmann.ac.il/report/2016/179/) [Slides](https://drive.google.com/open?id=1Ea_4PmfZZ8eoUdvpONVczvoDVxYhDv4W) [TCS+ Talk](https://www.youtube.com/watch?v=auT6ckYVnuo) STOC, 2017 (merged with "The Bipartite Formula Complexity of Inner-Product is Quadratic").

     [\[Oded's choices\]](http://www.wisdom.weizmann.ac.il/~oded/MC/211.html)

37. Time-Space Hardness of Learning Sparse Parities

     [PDF](http://eccc.weizmann.ac.il/report/2016/113/) [Slides](https://drive.google.com/open?id=1sP0eGuXN3Nt71mEStlEEZg89JOQ0ErDL) joint with Gillat Kol and Ran Raz.

    STOC, 2017.

38. Low-Sensitivity Functions from Unambiguous Certificates

     [PDF](https://arxiv.org/abs/1605.07084) joint with Shalev Ben-David and Pooya Hatami.

    ITCS, 2017.

39. Degree and Sensitivity: Tails of Two Distributions
...
40. On the Sensitivity Conjecture

     [PDF](http://eccc.weizmann.ac.il/report/2016/062/) [Slides](https://drive.google.com/open?id=1BdAWdGVJ8pHSFWMrnEolI28fJD6eWD3S) ICALP, 2016.

41. #SAT Algorithms from Shrinkage
...
43. Shrinkage of De Morgan Formulae by Spectral Techniques

     [PDF](http://eccc.weizmann.ac.il/report/2014/048/) [Slides](https://drive.google.com/open?id=1-DncCQYfvree-R6LFd9nA87_b6g_WuaA) FOCS, 2014.

44. On Fractional Block Sensitivity
...
45. Two Structural Results for Low Degree Polynomials and Applications
    ...
    An [implementation](http://structural.py/) of the algorithm suggested in Theorem 4.1.

46. On the Structure of Boolean Functions with Small Spectral Norm
...
47. Improved Average-Case Lower Bounds for De Morgan Formula Size
...
48. Properties and Applications of Boolean Function Composition

     [PDF](https://drive.google.com/open?id=12Vn3BT2ByZCFnEH0zlzkWGTxlx_N9Rw6) [Slides](http://bfc0308.pptx/) ITCS, 2013. (Best Student Paper)

     [\[Oded's choices\]](http://www.wisdom.weizmann.ac.il/~oded/MC/131.html)

49. On the Degree of Univariate Polynomials Over the Integers
...
50. On The Minimal Fourier Degree of Symmetric Boolean Functions
